...
function fetch_fedora_config() {
    curl -LSso fedora/"${1:?}".config 'https://git.kernel.org/pub/scm/linux/kernel/git/jwboyer/fedora.git/plain/fedora/configs/kernel-5.8.1-'"${1}"'.config?h=kernel-5.8.1-300.fc32'
}
