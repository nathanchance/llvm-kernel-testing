...
def parse_arguments():
    ...
    build_options_group = parser.add_argument_group('options to control aspects of build')
    ...
    prefix_group = parser.add_argument_group('options to control PATH customization')
